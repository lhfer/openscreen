				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#4A90E2]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#4A90E2]/20 text-[#4A90E2]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#4A90E2]" />
						)}
					</button>
				);
			})}
